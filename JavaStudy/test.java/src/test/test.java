...
public class test {
	...
	public static void main(String[] args) {
		// TODO 自動生成されたメソッド・スタブ ※参照テーブル テーブル名：test （Q1-5とQ1-6で利用する）
		...
		// Q1-5
		// 参照テーブルに下記データを追加するSQL文を記載してください(※回答のSQL文は、javaファイルでエラーになる為、コメントアウトすること)
		// id 1234, name Road, entrance_year 2017, section null
		// 例 SELECT name FROM staff（回答形式）
        //INSERT INTO test （id,name,entrance_year,section）VALUES （'1234','Road','2017','null'）

       

		// Q1-6
		// 参照テーブルの下記データを削除するSQL文を記載してください(回答のSQL文はコメントアウトすること)
		// id 0001または0002のものを削除
        //DELETE FROM test WHERE id='0001' OR id='0002';
